...
export async function getDriver(id: string) {
  return (await getDrivers()).find((driver) => driver.id.toString() === id)!
}

export async function getDriverRides(id: string) {
  return (await getRides()).filter((ride) => ride.driver.id.toString() === id)
}
  ...
  return [
    {
      ...
      driver: await getDriver('2000'),
    },
    {
      id: 5001,
      url: '/drivers/5000/rides/5001',
      date: 'Jan 27, 2026',
      earnings: '18.75',
      passenger: {
        name: 'Michael Chen',
    ...
    },
    {
      ...
      driver: await getDriver('2001'),
    },
    {
      id: 5003,
      url: '/drivers/5001/rides/5003',
      date: 'Jan 25, 2026',
      earnings: '15.50',
      passenger: {
...
export async function getDrivers() {
  return [
    ...
    },
    {
      ...
      totalEarningsChange: '+5.8%',
      ridesCompleted: 142,
      ridesCompletedChange: '+6.1%',
      rating: '4.9',
      ratingChange: '+0.3',
      status: 'Active',
    ...
    },
    {
      ...
      phone: '(555) 345-6789',
      totalEarnings: '$1,680.25',
      totalEarningsChange: '+3.2%',
      ridesCompleted: 98,
      ridesCompletedChange: '+2.4%',
      rating: '4.6',
      ratingChange: '+0.1',
      status: 'Active',
    ...
    },
    {
      ...
      totalEarningsChange: '-1.2%',
      ridesCompleted: 54,
      ridesCompletedChange: '-3.5%',
      rating: '4.4',
      ratingChange: '-0.2',
      status: 'Inactive',
